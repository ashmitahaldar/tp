...
public class SampleDataUtil {
    ...
    public static Person[] getSamplePersons() {
        ...
        sampleLogs.addLogEntry(new LogEntry("Met to discuss CS2103T", "meeting", LocalDateTime.parse("2025-09-30T20:45:00")));
        ...
        return new Person[] {
            ...
            new Person(new Name("Rajesh Kumar"), new Phone("92345678"), new TelegramHandle("@rajesh_vp"),
                ...
                getTagSet("VicePresident", "BusinessClub"), new Note("Can't stop petting Snowy (my cat)."), sampleLogs),
