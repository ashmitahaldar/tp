...
public class EditCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        // no index specified
        assertParseFailure(parser, VALID_NAME_AMY, MESSAGE_INVALID_INPUT + "\n" + MESSAGE_INVALID_FORMAT);

        // no index and no field specified
        assertParseFailure(parser, "", MESSAGE_INVALID_INPUT + "\n" + MESSAGE_INVALID_FORMAT);
    }
    ...
    public void parse_invalidPreamble_failure() {
        ...
        assertParseFailure(parser, "1 some random string", MESSAGE_INVALID_INPUT + "\n"
                + MESSAGE_INVALID_FORMAT);

        // invalid prefix being parsed as preamble
        assertParseFailure(parser, "1 i/ string", MESSAGE_INVALID_INPUT + "\n"
                + MESSAGE_INVALID_FORMAT);
    }
